<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Book.aspx.cs" Inherits="KitapEvi.Admin.Book" %>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtTitle" runat="server" CssClass="form-control" placeholder="Kitap ismi giriniz"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
    ...
    <asp:GridView ID="gvBookList" runat="server" CssClass="table table-bordered" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Aktif Mi?">
                <ItemTemplate>
                    <asp:CheckBox ID="CheckBox1" runat="server" Checked='<%# Convert.ToBoolean(Eval("is_active")) %>' Enabled="false" />
                </ItemTemplate>
            </asp:TemplateField>
